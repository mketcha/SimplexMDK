...
Bs = list(B2_1,B2_2,B2_3,B2_4,B2_5)
PI4 <- c( .25, .25, .25, .25);
PI3 <- c(.33, .33,.34)
PI2 <- c(.5,.5);
PIs = list(PI2,PI2,PI2,PI2,PI2)
trials <- 1000;
max_k <- 4;
nclust <- 3;
...
legend(locator(1), , legend = c("2/N", "1", "2", "3", "4", "5"), lty = c(19,19,19,19), col = c("black", "red", "green", "blue", "orange", "cyan"), lwd = 2)
...
legend(locator(1), c("1", "2", "3", "4", "5"), lty = c(19,19,19), col = c("red", "green", "blue", "orange", "cyan"), lwd = 2)
